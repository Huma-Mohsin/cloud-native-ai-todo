        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <div className="flex gap-3">
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className={`bg-gray-800 border-gray-600 hover:border-emerald-400 hover:bg-gray-600 text-white hover:text-emerald-400 transition-all font-semibold px-4 py-2 ${showSidebar ? 'bg-gray-600 border-emerald-400 text-emerald-400' : ''}`}
                >
                  📈 Analytics
                </Button>
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="bg-gray-800 border-gray-600 hover:border-emerald-400 hover:bg-gray-600 text-white hover:text-emerald-400 transition-all font-semibold px-4 py-2"
                >
                  📥 JSON
                </Button>
                <Button
                ...
                <Button
                  ...
                  className="bg-gray-800 border-gray-600 hover:border-red-400 hover:bg-red-900/20 hover:text-red-400 text-white transition-all font-semibold px-4 py-2"
                >
                  🚪 Logout
                </Button>
              </div>
            ...
            <button
              ...
              className="md:hidden p-2 rounded-lg hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-emerald-400 text-gray-200"
          ...
          {showMobileMenu && (
            <div className="md:hidden mt-4 pt-4 border-t border-gray-700 space-y-3">
              {user && (
                <div className="flex items-center gap-2 px-4 py-2.5 bg-gray-700 rounded-lg border border-gray-600 mb-2">
                  <svg className="w-5 h-5 text-emerald-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                  </svg>
                  <p className="text-sm font-medium text-gray-300">
              ...
              <div className="flex flex-col gap-2">
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className={`w-full justify-center bg-gray-800 border-gray-600 hover:border-emerald-400 hover:bg-gray-600 text-white hover:text-emerald-400 font-semibold ${showSidebar ? 'bg-gray-600 border-emerald-400 text-emerald-400' : ''}`}
                >
                  📈 Analytics
                </Button>
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="w-full justify-center bg-gray-800 border-gray-600 hover:border-emerald-400 hover:bg-gray-600 text-white hover:text-emerald-400 font-semibold"
                >
                  📥 JSON
                </Button>
                <Button
                ...
                <Button
                  ...
                  variant="outline"
                  isLoading={authLoading}
                  className="w-full justify-center bg-gray-800 border-gray-600 hover:border-red-400 hover:bg-red-900/20 hover:text-red-400 text-white font-semibold"
                >
                  🚪 Logout
                </Button>
              </div>
        ...
        <div className="space-y-3 sm:space-y-4 mb-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0">
            ...
            <button
              ...
              className="text-base font-medium text-emerald-400 hover:text-emerald-300 focus:outline-none whitespace-nowrap transition-colors"
            >
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            <h2 className="text-xl sm:text-2xl font-semibold text-white">
              ...
              {tasks.length > 0 && (
                <span className="ml-2 px-3 py-1 text-sm font-medium bg-emerald-600 text-white rounded-lg border border-emerald-500">
                  {tasks.length}
                </span>
              )}
            </h2>
